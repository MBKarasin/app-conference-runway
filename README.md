...
- On phones, the Calendar is a day-by-day agenda (opening at today in the current month), the header and filter rows are compact with swipeable chip rows, and turned sideways the filter bar scrolls away with the page. The desktop layout is unchanged.
