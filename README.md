...
- The header shows two time stamps, each with a status dot: **Verified** (the latest nightly verification; green, or red after 36 hours) and **Horizon scan** (when the latest search for meetings not yet listed finished; green once everything it found is reconciled, yellow while anything is open). The two indices sit below them.
