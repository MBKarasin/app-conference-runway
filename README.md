...
The public interface separates abstract calls into **Due within 30 days**, **Opening within 30 days** and **Open now** so each call appears once. Student opportunities and DNP project dissemination are presented as one discipline, while CAA records are grouped with CRNA for filtering. Visitors can switch among List, Calendar and **Orbit**: the annual Orbit places the year at its center, surrounds it with monthly density columns, and opens categorized meeting and abstract listings beside it. Location choices are collected under **Global Region**.
